...
class _ScheduleDataSendingScreenState extends State<ScheduleDataSendingScreen> {
  ...
  void initState() {
    ...
    if (widget.availableDevices.isNotEmpty) {
      _selectedDevice = widget.availableDevices.keys.first;
    }
  }
  ...
  Widget build(BuildContext context) {
    final deviceData =
        _selectedDevice != null
            ? widget.availableDevices[_selectedDevice]
            : null;
  ...
  void _saveSchedule() async {
    if (_selectedDevice == null || selectedTime == null) {
    ...
    try {
      ...
      final scheduleData = {
        ...
        'high': high,
        'low': low,
        'fcmToken': fcmToken, // Tambahkan token di sini
      };

      await FirebaseDatabase.instance
          .ref()
          .child('users/${widget.userId}/device/$_selectedDevice/schedule')
          .set(scheduleData);
